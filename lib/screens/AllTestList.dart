...
class AllTestList extends StatefulWidget {
  ...
  AllTestList(this.user);
  @override
  State<StatefulWidget> createState() {
    return _AllTestList(user);
  }
}

class _AllTestList extends State<AllTestList> {
  StudentUser user = StudentUser();
  _AllTestList(this.user);
  FileInfo fileInfo;
  String error;
  int downloaded = 0;
  int numberQuestions;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: Text('All tests'), backgroundColor: Colors.orangeAccent),
      body: Container(
        child: FutureBuilder(
          future: getAllTests(user.key),
